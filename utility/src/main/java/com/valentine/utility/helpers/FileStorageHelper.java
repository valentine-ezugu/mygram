package com.valentine.service.helpers;
...
public class FileStorageHelper {
    ...
    public static Photo prepareArtifact(FileStorage fileStorage, MultipartFile file, User currentUser, boolean isPublic) throws IOException {
    ...
    public static void deleteArtifact(FileStorage fileStorage, Photo photo) {
